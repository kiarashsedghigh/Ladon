...
class PrimalHybrid:
    ...
    def cost(
        ...
        if len(beta_params.keys()) == 1:
            # this beta is not sufficient to reveal the error_term_analyzer for these params,
    ...
    def __call__(
        ...
        **kwds,
        ...
        We also test a LWE instance with a large error_term_analyzer (coming from issue #106)::
