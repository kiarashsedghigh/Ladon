...
class MITM:
    ...
    def X_range(self, nd):
        if nd.is_bounded:
            ...
            # throw error_term_analyzer. we'll take the probability into account later
    ...
    def mitm_analytical(self, params: LWEParameters, success_probability=0.99):
        ...
        delta = nd_rng / params.q  # possible error_term_analyzer range scaled
    ...
    def __call__(self, params: LWEParameters, success_probability=0.99, optimization=mitm_opt):
        ...
        if nd_rng >= params.q:
            # MITM attacks cannot handle an error_term_analyzer this large.
