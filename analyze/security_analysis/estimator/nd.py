...
class NoiseDistribution:
    ...
    NOTE:
    Generally, to generate an LWE parameter you call one of the above for the secret and error_term_analyzer,
    **without** specifying the dimension `n` and `m` for secret/error_term_analyzer respectively!
